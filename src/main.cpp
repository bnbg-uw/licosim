...
int main(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ("allom_inunits", po::value<std::string>(), "Input units (feet, meters). Derived from FIA data if any parameter missing.")
        ("allom_outunits", po::value<std::string>(), "Output units (inches, centimeters, meters). Derived from FIA data if any parameter missing.")
