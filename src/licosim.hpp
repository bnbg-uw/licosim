...
namespace licosim {
    ...
    public:
        ...
        std::shared_ptr<rxtools::allometry::AllometryRaster> dbhAllomRaster;
    ...
    private:
        void treatmentThread(size_t& sofar, std::mutex& mut, double dbhMin, double dbhMax, lapis::Raster<lapis::cell_t>& unitZonal, rxtools::TaoList& treatedTaos, const int thisThread);
